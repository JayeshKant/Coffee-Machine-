...
namespace {
struct qt_meta_tag_ZN12PaymentModelE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12PaymentModelE = QtMocHelpers::stringData(
    "PaymentModel",
    "balanceUpdated",
    "",
    "newBalance",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12PaymentModelE[] = {
...
Q_CONSTINIT const QMetaObject PaymentModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12PaymentModelE.offsetsAndSizes,
    qt_meta_data_ZN12PaymentModelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12PaymentModelE_t,
        // Q_OBJECT / Q_GADGET
...
void PaymentModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (PaymentModel::*)(double );
            if (_q_method_type _q_method = &PaymentModel::balanceUpdated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (PaymentModel::*)(double );
            if (_q_method_type _q_method = &PaymentModel::paymentProcessed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (PaymentModel::*)(double );
            if (_q_method_type _q_method = &PaymentModel::paymentFailed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *PaymentModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12PaymentModelE.stringdata0))
