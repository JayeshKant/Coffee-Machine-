...
namespace {
struct qt_meta_tag_ZN12BrewingModelE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12BrewingModelE = QtMocHelpers::stringData(
    "BrewingModel",
    "brewingStepChanged",
    "",
    "step",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12BrewingModelE[] = {
...
Q_CONSTINIT const QMetaObject BrewingModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12BrewingModelE.offsetsAndSizes,
    qt_meta_data_ZN12BrewingModelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12BrewingModelE_t,
        // Q_OBJECT / Q_GADGET
...
void BrewingModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (BrewingModel::*)(const QString & );
            if (_q_method_type _q_method = &BrewingModel::brewingStepChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (BrewingModel::*)();
            if (_q_method_type _q_method = &BrewingModel::brewingFinished; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *BrewingModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12BrewingModelE.stringdata0))
